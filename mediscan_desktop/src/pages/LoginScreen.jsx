...
function LoginScreen() {
  const { login, setupVault, hasPassword } = useAuth();
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="form-container">
        <form className={`form ${showRegister ? 'show-register' : ''}`} onSubmit={handleSubmit} >
          {/* Lock Icon SVG */}
          <svg xmlns="http://www.w3.org/2000/svg" className="lock-icon" width="1em" height="1em" viewBox="0 0 24 24" strokeWidth="0" fill="currentColor" stroke="currentColor">
          ...
          <p className="form-title">
            {!hasPassword ? 'Setup Master Password' : (showRegister ? 'Register an account' : 'Welcome back')}
          </p>
            ...
            <div className="login-card">
              ...
              <div className="field-container">
                <input placeholder=""
                       ...
                       required
                       minLength={5}/>
                <span className="placeholder">Master Password</span>
              </div>

              <div className="button-row">
                <div className="register-position">
                  {/* Hide the Register button if they are in Setup Mode! */}
                  {hasPassword && (
                ...
                <button className="btn" type="submit">
                  <span className="btn-label">{!hasPassword ? "Secure Vault" : "Continue"}</span>
                </button>
              </div>
            </div>
